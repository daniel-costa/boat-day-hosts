...
'text!templates/DashboardBoatDayMultiTemplate.html',
...
], function(CaptainRequestModel, NotificationModel, ChatMessageModel, BoatModel, BoatDayModel, BaseView, DashboardTemplate, DashboardCaptainRequestRowTemplate, DashboardBoatRowTemplate, DashboardBoatDaySingleTemplate, DashboardBoatDayMultiTemplate, DashboardBoatDayRequestTemplate, DashboardBoatDayMessageTemplate){
		...
		render: function() {
			...
			Parse.Promise.when(queryBoats.find(), queryBoatDays.find()).then(function(boats, boatdays) {
				...
				if( boatdays.length > 0 ) {
					...
					//var tpl = _.template(DashboardBoatDayMultiTemplate);
					var tpl = _.template(DashboardBoatDaySingleTemplate);
